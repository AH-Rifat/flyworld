...
const VisaProcessingTimeTable = ({ data, onEdit }) => {
    const [isReadMore, setIsReadMore] = useState(false);

    const onDelete = (id) => {
        if (
            confirm(
                "Are you sure you want to delete this Visa Processing Time?"
            )
        ) {
                                ...
                                >
                                    ...
                                    <td className="px-4 py-3.5 text-sm text-gray-900 dark:text-white">
                                        {isReadMore
                                            ...
                                            : item.processing_time.slice(0, 50)}
                                        {item.processing_time.length > 50 && (
                                            <button
                                                onClick={() =>
...
export default VisaProcessingTimeTable;
