...
const ImportantDocumentsInfoTable = ({ data, onEdit }) => {
    const [isReadMore, setIsReadMore] = useState(false);

    const onDelete = (id) => {
        if (
            confirm(
                "Are you sure you want to delete this Important Documents Info?"
            )
        ) {
            router.delete(`/delete-important-documents-information/${id}`, {
                preserveScroll: true,
                onSuccess: () => {
                    toast.success("Important Documents Info deleted", {
                        position: "top-center",
                    });
                },
                onError: () => {
...
export default ImportantDocumentsInfoTable;
