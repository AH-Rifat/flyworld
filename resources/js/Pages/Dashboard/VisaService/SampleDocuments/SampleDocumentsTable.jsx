...
const SampleDocumentsTable = ({ data, onEdit }) => {
    const onDelete = (id) => {
        if (confirm("Are you sure you want to delete this Sample Document?")) {
            router.delete(`/delete-sample-documents-and-photos/${id}`, {
                preserveScroll: true,
                onSuccess: () => {
                    toast.success("Sample Document delete");
                },
                onError: () => {
...
export default SampleDocumentsTable;
